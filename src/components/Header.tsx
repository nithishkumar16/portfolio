      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-xl">Nithish</span>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <a href="https://github.com/nithishkumar16" target="_blank" rel="noopener noreferrer">
              <Github className="w-5 h-5 hover:text-primary-600 transition-colors" />
            </a>
            <a href="https://www.linkedin.com/in/nithishkumarvenkatesan/" target="_blank" rel="noopener noreferrer">
              <Linkedin className="w-5 h-5 hover:text-primary-600 transition-colors" />
            </a>
            <a href="mailto:nithish6@gmail.com">
              <Mail className="w-5 h-5 hover:text-primary-600 transition-colors" />
            </a>
          </div>
        </div>
      </div>
